    ...
    return (
        ...
        >
           <form onSubmit={handleSubmit} onChange={handleChange} type = "submit" className='m-8 flex flex-col space-y-4'>
                ...
                {/* <label className='font-semibold'>Give Description:</label>
                <input className=' bg-[#d8f9ff] text-start rounded-sm p-2' id='desc' type="text"/> */}
                <label className='font-semibold '> Quantity needed</label>
                <input value={qty} id='quantity' type='number' className=' bg-[#d8f9ff]  rounded-sm p-2' />
